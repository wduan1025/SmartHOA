...
contract HOAFactory{
    ...
    function createHOA(uint lower, string title) public{
        address currentAddress = new HOA(lower, msg.sender, title);
...
contract HOA{
    ...
    function HOA(uint lower, address creator, string title) public{
        manager = creator;
